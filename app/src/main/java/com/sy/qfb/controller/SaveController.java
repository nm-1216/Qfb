...
public class SaveController {
    ...
    public void saveData(List<MeasureData> lstData, SavedCallback callback) {
        new SaveDataTask(lstData, callback).execute();
    }

    public class SaveDataTask extends AsyncTask<Void, Integer, Void> {
        private List<MeasureData> listData;
        private SavedCallback callback;

        public SaveDataTask(List<MeasureData> data, SavedCallback cb) {
            this.listData = data;
            this.callback = cb;
        }
